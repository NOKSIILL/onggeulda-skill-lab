...
const translations = {
  ko: {
    ...
    memoryInstructions:
      "카드를 클릭해서 뒤집고, 같은 그림의 카드 두 개를 찾아 매치하세요.",
    memorySubInstructions:
      "모든 카드를 매치하면 게임이 완료됩니다. 최소한의 시도로 완성해보세요!",
    matchesLabel: "매치",
    movesLabel: "시도",
    newGameButton: "새 게임",
    ...
    aboutDescription:
      "Onggeulda Skill Lab은 일상적으로 연습하는 스킬 트레이닝과 간단한 창작 도구를 한 곳에서 제공하는 웹사이트입니다.",
    gamesSection: "🎮 게임 페이지:",
  ...
  en: {
    ...
    memoryInstructions: "Click cards to flip them and find matching pairs.",
    memorySubInstructions:
      "Match all cards to complete the game. Try to finish with the fewest moves!",
